...
export default function AboutPage() {
  return (
    <LegalLayout title="About GayGayFans">
      <h2>What is GayGayFans?</h2>
      <p>
        GayGayFans is a TikTok-style vertical video feed designed specifically for gay men.
      ...
      <p>
        ...
        Unlike piracy sites, every video on GayGayFans comes from verified creators who
      ...
      <h2>Safety First</h2>
      <p>
        GayGayFans implements age verification at entry, strict content moderation, and
